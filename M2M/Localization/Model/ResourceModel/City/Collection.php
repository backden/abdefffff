 ...
 * City collection
 */
namespace Isobar\Localization\Model\ResourceModel\City;
/**
 * Class Collection
 * @package Isobar\Localization\Model\ResourceModel\City
 */
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init('Isobar\Localization\Model\City', 'Isobar\Localization\Model\ResourceModel\City');
    ...
    protected function _initSelect()
    {
      ...
      $this->_logger->debug(__METHOD__ . ' ' . $locale);
      $locale = 'zh_CN';
      $this->_logger->debug(__METHOD__ . ' ' . $locale);
