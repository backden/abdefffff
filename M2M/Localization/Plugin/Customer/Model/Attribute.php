...
namespace Isobar\Localization\Plugin\Customer\Model;
/**
 * Class Attribute
 * @package Isobar\Localization\Plugin\Customer\Model
 */
class Attribute
{
    ...
    public function __construct(\Magento\Customer\Model\AttributeFactory $attrFactory)
    {
        ...
        $this->hiddenAttributes = \Isobar\Localization\Helper\Address::getHiddenAttributes();
    }
